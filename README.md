...
<a href="https://www.buymeacoffee.com/MadhavKrishanGoswami" style="margin-right: 10px;">
    <img src="https://img.shields.io/badge/Buy%20Me%20a%20Coffee-ffdd00?style=for-the-badge&logo=buy-me-a-coffee&logoColor=black" />
</a>
<a href="https://github.com/sponsors/MadhavKrishanGoswami">
...
- Color-matched icon glow effect (works best with [Seti Folder](https://marketplace.visualstudio.com/items?itemName=l-igh-t.antigravity-theme-seti-folder) icon theme)
...
1. Open **Extensions** in Antigravity (`Cmd+Shift+X` / `Ctrl+Shift+X`)
2. Search for **[Seti Folder](https://marketplace.visualstudio.com/items?itemName=l-igh-t.antigravity-theme-seti-folder)** (by `l-igh-t`)
3. Click **Install**
...
If you previously used the **Custom CSS and JS Loader** extension (`be5invis.antigravity-custom-css`), it may have injected CSS directly into Antigravity's `workbench.html` that persists even after disabling. If styles conflict, reinstall Antigravity to get a clean `workbench.html`, then use only **Custom UI Style**.
